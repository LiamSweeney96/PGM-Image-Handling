...
/*
    Program to take a binary input file and convert it 
    to the ascii format. This program requires 3 arguments,
    the program name, the file to convert, and an output file.
*/
